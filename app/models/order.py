...
class Order(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_order_is_finished_id", "is_finished", "id"),
        Index("ix_order_is_paid_id", "is_paid", "id"),
        Index("ix_order_is_rebate_id", "is_rebate", "id"),
        Index("ix_order_created_at_id", "created_at", "id"),
    )
